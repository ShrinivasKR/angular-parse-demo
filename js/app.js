...
angular.module('ToDoApp', ['ui.bootstrap'])
    .config(function($httpProvider) {
        ...
        $httpProvider.defaults.headers.common['X-Parse-Application-Id'] = 'Gysr5jSMdrzfPPbJdUTCrQ5qg8L74vykPUCx4yCG';
        $httpProvider.defaults.headers.common['X-Parse-REST-API-Key'] = 'BKrjbjLyPys6zAHBpFJHkT4KKuPOqJDq9DGLQXqg';
    })
